...
class Localization(object):
    def __init__(self):
        ...
        rospy.Subscriber("/drive_feedback_topic", Float64MultiArray, self.serial_callback)
    ...
    def serial_callback(self, data):
        ...
        self.front_left = self.encoder_data[0]
        self.back_left = self.encoder_data[1]
        self.front_right = self.encoder_data[2]
        self.back_right = self.encoder_data[3]
